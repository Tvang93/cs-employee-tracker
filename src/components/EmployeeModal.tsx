...
const EmployeeModal = ({
  ...
  const disableBtn =
    ...
    (employeeToChange.jobTitle.trim() == "" && employeeToChange.hireDate == "");
    ...
    <Dialog>
      <DialogTrigger asChild>
        ...
        <Button
          color="success"
          className={`${
            type === "Add" ? "flex items-center gap-1" : ""
        ...
        <div className="grid grid-cols-2 gap-3 min-h-[30rem]">
          <div>
            ...
            <div>
              ...
              <select
                id="jobTitle"
                className="text-sm border rounded p-1 hover:cursor-pointer"
              ...
              >
                ...
                <option className="cursor-pointer" value="Customer Support">
                  Customer Support
                </option>
                <option
                ...
                <option className="cursor-pointer" value="Software Engineer">
                  Software Engineer
                </option>
              </select>
            </div>
